...
simulator test. Persistent Ledger corruption is generated at exact frame
boundaries by core tests; broader Config, Provider failure, and Memory fixtures
land with the first vertical slice that consumes them.
