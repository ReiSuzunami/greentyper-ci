...
3. Add Git worktree allocation and explicit merge/conflict outcomes on top of the existing Unix Workspace Lease and Read Set writer gate; add an audited Windows handle adapter before enabling those operations there.
